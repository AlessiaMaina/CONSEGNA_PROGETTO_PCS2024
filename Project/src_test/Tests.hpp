...
TEST(TESTComputeTypeTrace, NonPassingTrace_FF)
{
    ...
    frac.VerticesOfFractures =
    {
        {{Vector3d(0, 0, 0),
          ...
          Vector3d(1, 1, 0),
          Vector3d(0, 1, 0)}},
        {{Vector3d(-2.3777799999999999e-01, 5.0000000000000000e-01, -3.4444000000000002e-01),
    ...
    {
        {{Vector3d(0.0000000000000000e+00, 5.0000000000000000e-01, 0.0000000000000000e+00),
...
TEST(TESTComputeTypeTrace, PassingTrace_TT)
{
    ...
    frac.VerticesOfFractures =
    {
        {{Vector3d(0, 0, 0),
         ...
         Vector3d(1, 1, 0),
         Vector3d(0, 1, 0)}},
        {{Vector3d(8.0000000000000004e-01, 0.0000000000000000e+00, -1.0000000000000001e-01),
    ...
    trac.VerticesOfTraces =
    {
        {{Vector3d(8.0000000000000004e-01, 0.0000000000000000e+00, 0.0000000000000000e+00),
